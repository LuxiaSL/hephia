...
from .formatters import InternalFormatter, ExoLoopFormatter, ConsoleFormatter, MemoryFormatter
...
class LogManager:
    ...
    def setup_logging():
        ...
        for directory in [internal_dir, exoloop_dir, system_dir, memory_dir]:
        ...
        for logger in [internal_logger, system_logger, brain_logger, memory_logger]:
